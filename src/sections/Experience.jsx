const experiences = [
  ...
  },
  {
    ...
    company: "Athlyn",
    description:
      "Developed responsive UI components and multi-step authentication flows using React and Tailwind CSS. Converted Figma designs into functional components and improved UI consistency.",
...
const Experience = () => {
  return (
    <section id="experience" className="py-32 relative overflow-hidden">
      <div className="absolute tap-1/2 left-1/4 w-96 h-96 bg-primary/5 rounded-full blur-3xl -translate-y-1/2" />
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <p className="text-muted-foreground animate-fade-in animation-delay-200">
            ...
            Frontend Developer leading teams and building products at scale.
          </p>
        </div>
                  ...
                  >
                    ...
                    >
                      {exp.technologies.map((tech, techIdx) => (
                        <span
                          key={techIdx}
                          className="px-3 py-1 bg-surface text-xs rounded-full text-muted-foreground border border-border/50 hover:border-primary/50 hover:text-primary transition-all duration-300"
                        >
                          {tech}
                        </span>
                      ))}
